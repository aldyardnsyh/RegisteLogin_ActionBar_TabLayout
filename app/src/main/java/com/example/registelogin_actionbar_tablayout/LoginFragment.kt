...
import com.example.registelogin_actionbar_tablayout.databinding.FragmentLoginBinding
    ...
    override fun onCreateView(
        ...
        with(binding) {
            ...
            btnLogin.setOnClickListener{
                if(editTxtUsername.text!!.isEmpty()) {
                    editTxtPassword.error = "Mohon Isi Username"
                } else if(editTxtPassword.text!!.isEmpty()) {
                    editTxtPassword.error = "Mohon Isi Password"
                } else {
                    editTxtUsername.text!!.clear()
